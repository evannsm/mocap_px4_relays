...
Mocap-agnostic relay nodes for bridging pose data to/from PX4. These nodes were extracted from [vicon4px4](https://github.com/evannsmc/vicon4px4) so they can be reused with any motion capture source (Vicon, OptiTrack, etc.).
